...
nodanger = "--> Despite the dangers of this room, you did not falter. You don't lose hitpoints."
success = "--> You have successfully overcome the dangers of this room! You gain 1 bravery point."
...
notyet = "--> You got through this room but did not find the golden door yet. Your journey continues."
game_over = "\n\n{} the Fallen! Your hitpoints have reached 0, and you could not find the golden door.\nYour chance to enter Valhalla is forever lost, and your spirit must remain between life \nand death for all eternity.\n"
game_won = "You have never seen anything so beautiful before.\nYou step through the door and suddenly, nothing you've been through seems to matter anymore.\nAs you look around, you see familiar faces, and an old, fierce man greets you with a smile.\nYou can now find eternal rest in the Halls of the Warriors."
divider = "\n-------------------------------------------------"
win = "\n------------- YOU WON! -------------\n"
lose = "\n------------- GAME OVER -------------\n"
